...
INSERT INTO medicamento(id, nombre, descripcion, categoria, fabricante, precio, requiere_receta, estado_medicamento, imagen_url) 
VALUES (2, 'Ibuprofeno', 'Antiinflamatorio no esteroideo', 'medications','Bayer', 5.00, 0, 1,'');
INSERT INTO medicamento(id, nombre, descripcion, categoria, fabricante, precio, requiere_receta, estado_medicamento, imagen_url) 
VALUES (3, 'Amoxicilina', 'Antibiótico de amplio espectro', 'medications','Pfizer', 8.75, 1, 1,'');
INSERT INTO medicamento(id, nombre, descripcion, categoria, fabricante, precio, requiere_receta, estado_medicamento, imagen_url) 
VALUES (4, 'Loratadina', 'Antihistamínico para alergias', 'medications', 'Sanofi', 4.20, 0, 1,'');
INSERT INTO medicamento(id, nombre, descripcion, categoria, fabricante, precio, requiere_receta, estado_medicamento, imagen_url) 
VALUES (5, 'Losartán', 'Antihipertensivo', 'medications', 'Sanofi', 10.00, 1, 1,'');
INSERT INTO medicamento(id, nombre, descripcion, categoria, fabricante, precio, requiere_receta, estado_medicamento, imagen_url) 
VALUES (6, 'Omeprazol', 'Inhibidor de la bomba de protones', 'medications', 'AstraZeneca', 3.90, 0, 1,'');
INSERT INTO medicamento(id, nombre, descripcion, categoria, fabricante, precio, requiere_receta, estado_medicamento, imagen_url) 
VALUES (7, 'Diazepam', 'Ansiolítico y relajante muscular', 'medications', 'Roche', 9.00, 1, 1,'');
INSERT INTO medicamento(id, nombre, descripcion, categoria, fabricante, precio, requiere_receta, estado_medicamento, imagen_url) 
VALUES (8, 'Metformina', 'Control de la glucosa en diabetes tipo 2', 'medications', 'Merck', 6.30, 1, 1,'');
INSERT INTO medicamento(id, nombre, descripcion, categoria, fabricante, precio, requiere_receta, estado_medicamento, imagen_url) 
VALUES (9, 'Simvastatina', 'Reduce el colesterol en sangre', 'medications', 'Novartis', 7.45, 1, 1,'');
INSERT INTO medicamento(id, nombre, descripcion, categoria, fabricante, precio, requiere_receta, estado_medicamento, imagen_url) 
VALUES (10, 'Aspirina', 'Analgésico y anticoagulante', 'medications', 'Bayer', 2.50, 0, 1,'');
-- Medicamentos Naturales
INSERT INTO medicamento(id, nombre, descripcion, categoria, fabricante, precio, requiere_receta, estado_medicamento, imagen_url) 
VALUES (11, 'Valeriana', 'Sedante natural para la ansiedad y el insomnio', 'natural-medicines', 'Nature’s Way', 5.80, 0, 1, '');
INSERT INTO medicamento(id, nombre, descripcion, categoria, fabricante, precio, requiere_receta, estado_medicamento, imagen_url) 
