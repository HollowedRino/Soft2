...
export const ProductItem = () => {
  ...
  const handleNavigation = () => {
    navigate('/producto/123'); // ← reemplaza con el ID dinámico si es necesario
  };

  const handleAddToCart = (e) => {
    e.stopPropagation(); // Previene la navegación
    console.log("Agregar al carrito");
    // Agrega tu lógica para añadir al carrito aquí
  };
